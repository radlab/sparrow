...
JAVA_OPTS+="-Dspark.local.dir=/disk1/sparrow/tmp/ -XX:+UseConcMarkSweepGC -Dspark.kryoserializer.buffer.mb=50 -Djava.library.path=$SPARK_LIBRARY_PATH:$FWDIR/lib:$FWDIR/src/main/native:$MESOS_LIBRARY_PATH"
