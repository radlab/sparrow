  ...
  public static class updateNodeState_args implements org.apache.thrift.TBase<updateNodeState_args, updateNodeState_args._Fields>, java.io.Serializable, Cloneable   {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.snapshot = new HashMap<String,edu.berkeley.sparrow.thrift.TNodeState>(2*_map46.size);
                  for (int _i47 = 0; _i47 < _map46.size; ++_i47)
                  {
                    String _key48; // required
                    edu.berkeley.sparrow.thrift.TNodeState _val49; // optional
                    _key48 = iprot.readString();
                    _val49 = new edu.berkeley.sparrow.thrift.TNodeState();
                    _val49.read(iprot);
                    struct.snapshot.put(_key48, _val49);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateNodeState_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.snapshot != null) {
          oprot.writeFieldBegin(SNAPSHOT_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, edu.berkeley.sparrow.thrift.TNodeState> _iter50 : struct.snapshot.entrySet())
            {
    ...
    private static class updateNodeState_argsTupleScheme extends TupleScheme<updateNodeState_args> {
        ...
        if (struct.isSetSnapshot()) {
          {
            ...
            for (Map.Entry<String, edu.berkeley.sparrow.thrift.TNodeState> _iter51 : struct.snapshot.entrySet())
            {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, updateNodeState_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(0)) {
          {
            org.apache.thrift.protocol.TMap _map52 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.snapshot = new HashMap<String,edu.berkeley.sparrow.thrift.TNodeState>(2*_map52.size);
            for (int _i53 = 0; _i53 < _map52.size; ++_i53)
            {
              String _key54; // required
              edu.berkeley.sparrow.thrift.TNodeState _val55; // optional
              _key54 = iprot.readString();
              _val55 = new edu.berkeley.sparrow.thrift.TNodeState();
              _val55.read(iprot);
              struct.snapshot.put(_key54, _val55);
            }
          }
          struct.setSnapshotIsSet(true);
        }
