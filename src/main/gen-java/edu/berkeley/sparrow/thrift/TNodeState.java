      ...
      switch (field.id) {
        case 1: // SPARROW_USAGE
          if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
            this.sparrowUsage = new TResourceVector();
            this.sparrowUsage.read(iprot);
          } else { 
        ...
        case 2: // EXTERNAL_USAGE
          if (field.type == org.apache.thrift.protocol.TType.STRUCT) {
            this.externalUsage = new TResourceVector();
            this.externalUsage.read(iprot);
          } else { 
            org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
          }
          break;
