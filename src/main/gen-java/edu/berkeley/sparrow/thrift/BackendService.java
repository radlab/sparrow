              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.resources = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>(2*_map34.size);
                  for (int _i35 = 0; _i35 < _map34.size; ++_i35)
                  {
                    edu.berkeley.sparrow.thrift.TUserGroupInfo _key36; // required
                    edu.berkeley.sparrow.thrift.TResourceVector _val37; // required
                    _key36 = new edu.berkeley.sparrow.thrift.TUserGroupInfo();
                    _key36.read(iprot);
                    _val37 = new edu.berkeley.sparrow.thrift.TResourceVector();
                    _val37.read(iprot);
                    struct.resources.put(_key36, _val37);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateResourceLimits_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.resources != null) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> _iter38 : struct.resources.entrySet())
            {
        ...
        if (struct.isSetResources()) {
          {
            ...
            for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> _iter39 : struct.resources.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.resources = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>(2*_map40.size);
            for (int _i41 = 0; _i41 < _map40.size; ++_i41)
            {
              edu.berkeley.sparrow.thrift.TUserGroupInfo _key42; // required
              edu.berkeley.sparrow.thrift.TResourceVector _val43; // required
              _key42 = new edu.berkeley.sparrow.thrift.TUserGroupInfo();
              _key42.read(iprot);
              _val43 = new edu.berkeley.sparrow.thrift.TResourceVector();
              _val43.read(iprot);
              struct.resources.put(_key42, _val43);
            }
          }
          struct.setResourcesIsSet(true);
        }
