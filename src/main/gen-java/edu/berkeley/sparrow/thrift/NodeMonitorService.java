            ...
            if (field.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                this.usage = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>(2*_map4.size);
                for (int _i5 = 0; _i5 < _map4.size; ++_i5)
                {
                  edu.berkeley.sparrow.thrift.TUserGroupInfo _key6; // required
                  edu.berkeley.sparrow.thrift.TResourceVector _val7; // required
                  _key6 = new edu.berkeley.sparrow.thrift.TUserGroupInfo();
                  _key6.read(iprot);
                  _val7 = new edu.berkeley.sparrow.thrift.TResourceVector();
                  _val7.read(iprot);
                  this.usage.put(_key6, _val7);
                }
                iprot.readMapEnd();
              }
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.usage != null) {
        oprot.writeFieldBegin(USAGE_FIELD_DESC);
        {
          ...
          for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> _iter11 : this.usage.entrySet())
          {
