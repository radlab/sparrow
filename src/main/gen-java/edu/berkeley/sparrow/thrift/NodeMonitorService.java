...
public class NodeMonitorService {
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_updateResourceUsage(String app, Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage, List<edu.berkeley.sparrow.thrift.TFullTaskId> activeTaskIds) throws org.apache.thrift.TException
    {
      ...
      args.setApp(app);
      args.setUsage(usage);
      args.setActiveTaskIds(activeTaskIds);
      sendBase("updateResourceUsage", args);
    }

    public void recv_updateResourceUsage() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class updateResourceUsage_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_updateResourceUsage();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    private static class updateResourceUsage<I extends Iface> extends org.apache.thrift.ProcessFunction<I, updateResourceUsage_args> {
      public updateResourceUsage() {
        super("updateResourceUsage");
      }

      protected updateResourceUsage_args getEmptyArgsInstance() {
  ...
  public static class updateResourceUsage_args implements org.apache.thrift.TBase<updateResourceUsage_args, updateResourceUsage_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final org.apache.thrift.protocol.TField APP_FIELD_DESC = new org.apache.thrift.protocol.TField("app", org.apache.thrift.protocol.TType.STRING, (short)1);
    private static final org.apache.thrift.protocol.TField USAGE_FIELD_DESC = new org.apache.thrift.protocol.TField("usage", org.apache.thrift.protocol.TType.MAP, (short)2);
    private static final org.apache.thrift.protocol.TField ACTIVE_TASK_IDS_FIELD_DESC = new org.apache.thrift.protocol.TField("activeTaskIds", org.apache.thrift.protocol.TType.LIST, (short)3);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new updateResourceUsage_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new updateResourceUsage_argsTupleSchemeFactory());
    }
    ...
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      APP((short)1, "app"),
      USAGE((short)2, "usage"),
      ACTIVE_TASK_IDS((short)3, "activeTaskIds");
    ...
    public updateResourceUsage_args(updateResourceUsage_args other) {
      ...
      if (other.isSetUsage()) {
        Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> __this__usage = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>();
        for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> other_element : other.usage.entrySet()) {
          ...
          edu.berkeley.sparrow.thrift.TUserGroupInfo __this__usage_copy_key = new edu.berkeley.sparrow.thrift.TUserGroupInfo(other_element_key);

          edu.berkeley.sparrow.thrift.TResourceVector __this__usage_copy_value = new edu.berkeley.sparrow.thrift.TResourceVector(other_element_value);

          __this__usage.put(__this__usage_copy_key, __this__usage_copy_value);
        }
    ...
    public updateResourceUsage_args setApp(String app) {
      this.app = app;
      return this;
    }
    ...
    public int getUsageSize() {
      return (this.usage == null) ? 0 : this.usage.size();
    }

    public void putToUsage(edu.berkeley.sparrow.thrift.TUserGroupInfo key, edu.berkeley.sparrow.thrift.TResourceVector val) {
      if (this.usage == null) {
        this.usage = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>();
      }
      this.usage.put(key, val);
    }

    public Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> getUsage() {
      return this.usage;
    }

    public updateResourceUsage_args setUsage(Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage) {
      this.usage = usage;
      return this;
    }
    ...
    public int getActiveTaskIdsSize() {
    ...
    public void unsetActiveTaskIds() {
      this.activeTaskIds = null;
    }

    /** Returns true if field activeTaskIds is set (has been assigned a value) and false otherwise */
    public boolean isSetActiveTaskIds() {
      return this.activeTaskIds != null;
    }

    public void setActiveTaskIdsIsSet(boolean value) {
      if (!value) {
        this.activeTaskIds = null;
      }
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case USAGE:
        if (value == null) {
          ...
          setUsage((Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>)value);
        }
        break;
    ...
    public boolean equals(updateResourceUsage_args that) {
      ...
      boolean this_present_activeTaskIds = true && this.isSetActiveTaskIds();
      boolean that_present_activeTaskIds = true && that.isSetActiveTaskIds();
      if (this_present_activeTaskIds || that_present_activeTaskIds) {
        if (!(this_present_activeTaskIds && that_present_activeTaskIds))
          return false;
        if (!this.activeTaskIds.equals(that.activeTaskIds))
          return false;
      }
    ...
    public int compareTo(updateResourceUsage_args other) {
      ...
      int lastComparison = 0;
      updateResourceUsage_args typedOther = (updateResourceUsage_args)other;
      ...
      lastComparison = Boolean.valueOf(isSetActiveTaskIds()).compareTo(typedOther.isSetActiveTaskIds());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetActiveTaskIds()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.activeTaskIds, typedOther.activeTaskIds);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("updateResourceUsage_args(");
      boolean first = true;
      ...
      first = false;
      if (!first) sb.append(", ");
      sb.append("activeTaskIds:");
      if (this.activeTaskIds == null) {
        sb.append("null");
      } else {
        sb.append(this.activeTaskIds);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class updateResourceUsage_argsStandardSchemeFactory implements SchemeFactory {
      public updateResourceUsage_argsStandardScheme getScheme() {
        return new updateResourceUsage_argsStandardScheme();
      }
    }

    private static class updateResourceUsage_argsStandardScheme extends StandardScheme<updateResourceUsage_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.usage = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>(2*_map8.size);
                  for (int _i9 = 0; _i9 < _map8.size; ++_i9)
                  {
                    edu.berkeley.sparrow.thrift.TUserGroupInfo _key10; // required
                    edu.berkeley.sparrow.thrift.TResourceVector _val11; // required
                    _key10 = new edu.berkeley.sparrow.thrift.TUserGroupInfo();
                    _key10.read(iprot);
                    _val11 = new edu.berkeley.sparrow.thrift.TResourceVector();
                    _val11.read(iprot);
                    struct.usage.put(_key10, _val11);
                  }
                  iprot.readMapEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.activeTaskIds = new ArrayList<edu.berkeley.sparrow.thrift.TFullTaskId>(_list12.size);
                  for (int _i13 = 0; _i13 < _list12.size; ++_i13)
                  {
                    edu.berkeley.sparrow.thrift.TFullTaskId _elem14; // required
                    _elem14 = new edu.berkeley.sparrow.thrift.TFullTaskId();
                    _elem14.read(iprot);
                    struct.activeTaskIds.add(_elem14);
                  }
                  iprot.readListEnd();
                }
                struct.setActiveTaskIdsIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
              }
              break;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateResourceUsage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.usage != null) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, struct.usage.size()));
            for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> _iter15 : struct.usage.entrySet())
            {
        ...
        if (struct.activeTaskIds != null) {
          oprot.writeFieldBegin(ACTIVE_TASK_IDS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.activeTaskIds.size()));
            for (edu.berkeley.sparrow.thrift.TFullTaskId _iter16 : struct.activeTaskIds)
            {
              _iter16.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class updateResourceUsage_argsTupleSchemeFactory implements SchemeFactory {
      public updateResourceUsage_argsTupleScheme getScheme() {
        return new updateResourceUsage_argsTupleScheme();
      }
    }

    private static class updateResourceUsage_argsTupleScheme extends TupleScheme<updateResourceUsage_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, updateResourceUsage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetUsage()) {
          {
            oprot.writeI32(struct.usage.size());
            for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> _iter17 : struct.usage.entrySet())
            {
        ...
        if (struct.isSetActiveTaskIds()) {
          {
            oprot.writeI32(struct.activeTaskIds.size());
            for (edu.berkeley.sparrow.thrift.TFullTaskId _iter18 : struct.activeTaskIds)
            {
              _iter18.write(oprot);
            }
          }
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, updateResourceUsage_args struct) throws org.apache.thrift.TException {
        ...
        if (incoming.get(1)) {
          {
            org.apache.thrift.protocol.TMap _map19 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
            struct.usage = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>(2*_map19.size);
            for (int _i20 = 0; _i20 < _map19.size; ++_i20)
            {
              edu.berkeley.sparrow.thrift.TUserGroupInfo _key21; // required
              edu.berkeley.sparrow.thrift.TResourceVector _val22; // required
              _key21 = new edu.berkeley.sparrow.thrift.TUserGroupInfo();
              _key21.read(iprot);
              _val22 = new edu.berkeley.sparrow.thrift.TResourceVector();
              _val22.read(iprot);
              struct.usage.put(_key21, _val22);
            }
          }
          struct.setUsageIsSet(true);
        }
        if (incoming.get(2)) {
          {
            ...
            struct.activeTaskIds = new ArrayList<edu.berkeley.sparrow.thrift.TFullTaskId>(_list23.size);
            for (int _i24 = 0; _i24 < _list23.size; ++_i24)
            {
              edu.berkeley.sparrow.thrift.TFullTaskId _elem25; // required
              _elem25 = new edu.berkeley.sparrow.thrift.TFullTaskId();
              _elem25.read(iprot);
              struct.activeTaskIds.add(_elem25);
            }
          }
          struct.setActiveTaskIdsIsSet(true);
        }
  ...
  public static class updateResourceUsage_result implements org.apache.thrift.TBase<updateResourceUsage_result, updateResourceUsage_result._Fields>, java.io.Serializable, Cloneable   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new updateResourceUsage_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new updateResourceUsage_resultTupleSchemeFactory());
    }
...
;
    ...
    public int compareTo(updateResourceUsage_result other) {
      ...
      int lastComparison = 0;
      updateResourceUsage_result typedOther = (updateResourceUsage_result)other;
    ...
    private static class updateResourceUsage_resultStandardSchemeFactory implements SchemeFactory {
      public updateResourceUsage_resultStandardScheme getScheme() {
        return new updateResourceUsage_resultStandardScheme();
      }
    }

    private static class updateResourceUsage_resultStandardScheme extends StandardScheme<updateResourceUsage_result> {
    ...
    private static class updateResourceUsage_resultTupleSchemeFactory implements SchemeFactory {
      public updateResourceUsage_resultTupleScheme getScheme() {
        return new updateResourceUsage_resultTupleScheme();
      }
    }

    private static class updateResourceUsage_resultTupleScheme extends TupleScheme<updateResourceUsage_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new ArrayList<edu.berkeley.sparrow.thrift.TFullTaskId>(_list26.size);
                  for (int _i27 = 0; _i27 < _list26.size; ++_i27)
                  {
                    edu.berkeley.sparrow.thrift.TFullTaskId _elem28; // required
                    _elem28 = new edu.berkeley.sparrow.thrift.TFullTaskId();
                    _elem28.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, tasksFinished_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (edu.berkeley.sparrow.thrift.TFullTaskId _iter29 : struct.tasks)
            {
              _iter29.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetTasks()) {
          {
            ...
            for (edu.berkeley.sparrow.thrift.TFullTaskId _iter30 : struct.tasks)
            {
              _iter30.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.tasks = new ArrayList<edu.berkeley.sparrow.thrift.TFullTaskId>(_list31.size);
            for (int _i32 = 0; _i32 < _list31.size; ++_i32)
            {
              edu.berkeley.sparrow.thrift.TFullTaskId _elem33; // required
              _elem33 = new edu.berkeley.sparrow.thrift.TFullTaskId();
              _elem33.read(iprot);
