...
public class NodeMonitorService {
  ...
  public interface Iface {
    ...
    public void updateResourceUsage(String app, Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage, List<ByteBuffer> activeTaskIds) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void updateResourceUsage(String app, Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage, List<ByteBuffer> activeTaskIds, org.apache.thrift.async.AsyncMethodCallback<AsyncClient.updateResourceUsage_call> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_updateResourceUsage(String app, Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage, List<ByteBuffer> activeTaskIds) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void updateResourceUsage(String app, Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage, List<ByteBuffer> activeTaskIds, org.apache.thrift.async.AsyncMethodCallback<updateResourceUsage_call> resultHandler) throws org.apache.thrift.TException {
      checkReady();
    ...
    public static class updateResourceUsage_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      private List<ByteBuffer> activeTaskIds;
      public updateResourceUsage_call(String app, Map<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector> usage, List<ByteBuffer> activeTaskIds, org.apache.thrift.async.AsyncMethodCallback<updateResourceUsage_call> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.app = app;
        this.usage = usage;
  ...
  public static class registerBackend_args implements org.apache.thrift.TBase<registerBackend_args, registerBackend_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (field.id) {
          ...
          case 2: // LISTEN_SOCKET
            if (field.type == org.apache.thrift.protocol.TType.STRING) {
              this.listenSocket = iprot.readString();
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, field.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.listenSocket != null) {
        ...
        oprot.writeString(this.listenSocket);
        oprot.writeFieldEnd();
      }
  ...
  public static class updateResourceUsage_args implements org.apache.thrift.TBase<updateResourceUsage_args, updateResourceUsage_args._Fields>, java.io.Serializable, Cloneable   {
    ...
    public List<ByteBuffer> activeTaskIds; // required
    ...
    public updateResourceUsage_args(updateResourceUsage_args other) {
      ...
      if (other.isSetActiveTaskIds()) {
        List<ByteBuffer> __this__activeTaskIds = new ArrayList<ByteBuffer>();
        for (ByteBuffer other_element : other.activeTaskIds) {
          ByteBuffer temp_binary_element = org.apache.thrift.TBaseHelper.copyBinary(other_element);
;
          __this__activeTaskIds.add(temp_binary_element);
        }
    ...
    public java.util.Iterator<ByteBuffer> getActiveTaskIdsIterator() {
      return (this.activeTaskIds == null) ? null : this.activeTaskIds.iterator();
    }

    public void addToActiveTaskIds(ByteBuffer elem) {
      if (this.activeTaskIds == null) {
        this.activeTaskIds = new ArrayList<ByteBuffer>();
      }
      this.activeTaskIds.add(elem);
    }

    public List<ByteBuffer> getActiveTaskIds() {
      return this.activeTaskIds;
    }

    public updateResourceUsage_args setActiveTaskIds(List<ByteBuffer> activeTaskIds) {
      this.activeTaskIds = activeTaskIds;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case ACTIVE_TASK_IDS:
        if (value == null) {
          ...
          setActiveTaskIds((List<ByteBuffer>)value);
        }
        break;
            ...
            if (field.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                this.usage = new HashMap<edu.berkeley.sparrow.thrift.TUserGroupInfo,edu.berkeley.sparrow.thrift.TResourceVector>(2*_map8.size);
            ...
            if (field.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                this.activeTaskIds = new ArrayList<ByteBuffer>(_list12.size);
                for (int _i13 = 0; _i13 < _list12.size; ++_i13)
                {
                  ByteBuffer _elem14; // required
                  _elem14 = iprot.readBinary();
                  this.activeTaskIds.add(_elem14);
                }
                iprot.readListEnd();
              }
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
      ...
      if (this.usage != null) {
        ...
        {
          oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, this.usage.size()));
          for (Map.Entry<edu.berkeley.sparrow.thrift.TUserGroupInfo, edu.berkeley.sparrow.thrift.TResourceVector> _iter15 : this.usage.entrySet())
          {
      ...
      if (this.activeTaskIds != null) {
        oprot.writeFieldBegin(ACTIVE_TASK_IDS_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter16 : this.activeTaskIds)
          {
