    ...
    private static class updateResourceUsage_argsStandardScheme extends StandardScheme<updateResourceUsage_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  for (int _i9 = 0; _i9 < _map8.size; ++_i9)
                  {
                    ...
                    edu.berkeley.sparrow.thrift.TResourceVector _val11; // optional
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.activeTaskIds = new ArrayList<String>(_list12.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, updateResourceUsage_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.activeTaskIds != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, struct.activeTaskIds.size()));
            for (String _iter16 : struct.activeTaskIds)
            {
        ...
        if (struct.isSetActiveTaskIds()) {
          {
            ...
            for (String _iter18 : struct.activeTaskIds)
            {
        ...
        if (incoming.get(1)) {
          {
            ...
            for (int _i20 = 0; _i20 < _map19.size; ++_i20)
            {
              ...
              edu.berkeley.sparrow.thrift.TResourceVector _val22; // optional
        ...
        if (incoming.get(2)) {
          {
            ...
            struct.activeTaskIds = new ArrayList<String>(_list23.size);
